...
class InceptionTimeWithROPClassifier(InceptionTimeClassifier):
    ...
    def _fit(self, X, y):
        ...
        for n in range(0, self.n_classifiers):
            cls = IndividualInceptionWithROPClassifier(
...
class IndividualInceptionWithROPClassifier(CustomIndividualInceptionClassifier):
    def __init__(
        self,
        n_filters=32,
        n_conv_per_layer=3,
